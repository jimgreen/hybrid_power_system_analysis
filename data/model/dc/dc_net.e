...
# 0 line_1_0_3 0 3 0.01 1
# 1 line_1_0_3 0 3 0.01 1
# 2 line_1_0_3 0 3 0.01 1
# 3 line_1_0_3 0 3 0.01 1
</DCBranch>

<DCLoad>
@ idx name node pbase pv0 pv1 pv2 run_stat
# 0 load_1_1 0 1.0 100 0 0 1
# 1 load_1_2 1 1.0 0 0 50 1
# 2 load_1_3 2 1.0 50 80 0 1
# 3 load_1_3 3 1.0 70 20 80 1
</DCLoad>

<DCGenerator>
@ idx name node control_type v_set p_set i_set run_stat
# 0 gen_1_1 4 V 110 0 0 1
# 1 gen_2_1 3 P 110 50 0 1
# 2 gen_3_1 3 I 110 50 0.001 1
</DCGenerator>
...
# 0 conv_1_2_3 4 3 0.005 0.005 V 0 0 110 1
</DCDCConverter>
