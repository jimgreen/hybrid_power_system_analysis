...
# 29 line_22_23 3 4 0.0003 1
</DCBranch>

<DCLoad>
@ idx name node pbase pv0 pv1 pv2 run_stat
# 0 ld_1 0 1.0 100 0 0 1
</DCLoad>

<DCGenerator>
@ idx name node control_type v_set p_set i_set run_stat
# 0 gen_v1 2 V 120 100 0 1
# 10 gen_i4 5 V 130 0 0.001 1
</DCGenerator>
...
# 6 conv_link 3 2 0.015 0.015 V 0 0 100 1
# 7 conv_7 4 5 0 0 P 100 0.0005 0 1
</DCDCConverter>
