...
# 0 line_1_4 0 3 0 0.0576 0 1
# 1 line_4_5 3 4 0.017 0.092 0.158 1
# 2 line_5_6 4 5 0.039 0.17 0.358 1
# 3 line_3_6 2 5 0 0.0586 0 1
# 4 line_6_7 5 6 0.0119 0.1008 0.209 1
# 5 line_7_8 6 7 0.0085 0.072 0.149 1
# 6 line_8_2 7 1 0 0.0625 0 1
# 7 line_8_9 7 8 0.032 0.161 0.306 1
# 8 line_9_4 8 3 0.01 0.085 0.176 1
</ACBranch>

<ACLoad>
@ idx name node pbase pv0 pv1 pv2 qbase qv0 qv1 qv2 run_stat
# 0 load_5 4 1.0 90 0.0 0.0 1.0 30 0.0 0.0 1
# 1 load_7 6 1.0 100 0.0 0.0 1.0 35 0.0 0.0 1
# 2 load_9 8 1.0 125 0.0 0.0 1.0 50 0.0 0.0 1
</ACLoad>

<ACGenerator>
@ idx name node control_type p_set q_set v_set alpha run_stat
# 0 gen_1_0 0 V 0 0 345 1.0 1
# 1 gen_2_1 1 PV 163 0 345 1.0 1
# 2 gen_3_2 2 PV 85 0 345 1.0 1
</ACGenerator>
