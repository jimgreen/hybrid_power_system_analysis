...
# 29 line_22_23 22 23 0.1 1
# 30 line_23_24 23 24 0.2 1
# 31 line_24_20 24 20 0.04 1
# 32 line_25_26 25 26 0.1 1
# 33 line_26_27 26 27 0.2 1
# 34 line_27_28 27 28 0.03 1
# 35 line_28_29 28 29 0.1 1
# 36 line_29_25 29 25 0.2 1
</DCBranch>

<DCLoad>
@ idx name node pbase pv0 pv1 pv2 run_stat
# 0 load_1 0 1.0 100 10 10 1
# 1 load_2 2 1.0 100 20 0 1
# 2 load_3 4 1.0 100 10 20 1
# 3 load_4 6 1.0 100 20 0 1
# 4 load_5 8 1.0 100 10 10 1
# 5 load_6 10 1.0 100 20 0 1
# 6 load_7 12 1.0 100 10 20 1
# 7 load_8 14 1.0 100 20 0 1
# 8 load_9 16 1.0 100 10 10 1
# 9 load_10 18 1.0 100 20 0 1
# 10 load_11 19 1.0 100 20 20 1
# 11 load_12 20 1.0 100 10 0 1
# 12 load_13 22 1.0 100 20 10 1
# 13 load_14 24 1.0 100 10 0 1
# 14 load_15 26 1.0 100 20 20 1
# 15 load_16 28 1.0 100 10 0 1
</DCLoad>

<DCGenerator>
@ idx name node control_type v_set p_set i_set run_stat
# 0 gen_v1 3 V 160 100 0 1
...
# 11 gen_p5 25 V 140 200 0 1
# 12 gen_i5 27 I 0 0 0.0012 1
# 13 gen_p6 29 P 0 120 0 1
</DCGenerator>
...
# 0 conv_1 4 5 0.05 0.05 P 200 0 0 1
# 1 conv_2 8 9 0.1 0.1 P 100 0 0 1
# 2 conv_3 12 13 0.075 0.075 I 0 0.0015 0 1
# 3 conv_4 16 17 0.06 0.06 P 150 0 0 1
# 4 conv_5 18 19 0.09 0.09 I 0 0.001 0 1
# 5 conv_6 0 15 0.125 0.125 P 100 0 0 1
# 6 conv_link 20 10 0.075 0.075 V 0 0 120 1
# 7 conv_7 22 23 0.05 0.05 P 120 0 0 1
# 8 conv_8 26 27 0.06 0.06 I 0 0.0008 0 1
</DCDCConverter>

<DCACConverter>
@ idx name ac_node dc_node r1 r2 control_type p_ac_set q_ac_set v_ac_set v_dc_set run_stat
# 0 inv_dcv 7 22 0.02 0.02 DCV 0 0 0 117.2556 1
# 1 inv_acv 8 24 0.02 0.02 ACV 0 0 0.823466 0 1
# 2 inv_acp 9 28 0.02 0.02 ACP -10 0 0 0 1
</DCACConverter>

<ACACConverter>
@ idx name i_node j_node r1 r2 control_type p_set i_q_set j_q_set i_v_set j_v_set run_stat
# 0 acac_3_4 3 4 0.01 0.01 PQQ 5 0 0 0 0 1
</ACACConverter>
