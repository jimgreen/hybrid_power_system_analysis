"""Hydrogen-network state estimation (historical module name: hydro)."""
...
DEFAULT_MEAS = measurement_file("hydro", "hydro_net_3.meas")


class HydroStateEstimator(FluidStateEstimator):
    pass


def main(argv=None) -> int:
    parser = argparse.ArgumentParser(description="Hydrogen-network state estimation")
