...
DEFAULT_MEAS = measurement_file("gas", "gas_net_3.meas")


class GasStateEstimator(FluidStateEstimator):
    pass


def main(argv=None) -> int:
    parser = argparse.ArgumentParser(description="Gas-network state estimation")
