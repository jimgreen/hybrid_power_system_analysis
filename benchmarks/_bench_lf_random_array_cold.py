"""Single-process random-order cold-start LF benchmark in array mode.
...
- end-to-end timing
- 5 runs per case
- no cross-process cache / no warmup
...
def main():
    parser = argparse.ArgumentParser(description="Single-process random-order cold-start LF benchmark in array mode.")
    ...
    print(f"Measure: {args.repeat} randomized rounds (cold-start, no warmup)...")
    all_runs = []
